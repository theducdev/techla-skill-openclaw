---
name: mkt-chay-qc-fb
description: Chạy quảng cáo Facebook (Meta Ads), tạo chiến dịch, viết ad copy, target đối tượng, theo dõi chỉ số quảng cáo. Sử dụng khi cần tạo campaign Facebook Ads, viết nội dung quảng cáo, thiết lập audience, theo dõi CTR/CPC/ROAS, tối ưu quảng cáo. Trigger khi user yêu cầu chạy quảng cáo Facebook, tạo ads, xem chỉ số QC, hoặc tối ưu campaign.
---

# Ad Creative & Copy Generation (Facebook/Meta Ads)
